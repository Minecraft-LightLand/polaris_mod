...
public enum PolarisArmorMaterial implements IArmorMaterial {
	STARDUST("stardust", 5, new int[]{3, 8, 6, 3}, 15,
			SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> Ingredient.of(PolarisItems.LIFE_OF_SEEDS.get())),
	STARBURST("starburst", 5, new int[]{3, 9, 6, 3}, 15,
			SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.125F, () -> Ingredient.of(PolarisItems.LIFE_OF_SEEDS.get())),
	STAR_LORD("star_lord", 5, new int[]{4, 9, 7, 4}, 15,
			SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.15F, () -> Ingredient.of(PolarisItems.LIFE_OF_SEEDS.get())),
	...
	SupremeGenesis("supreme_genesis", 5, new int[]{7, 10, 10, 7}, 15,
			SoundEvents.ARMOR_EQUIP_NETHERITE, 6.0F, 0.225F, () -> Ingredient.of(PolarisItems.SPIRIT_OF_DIVINITY.get())),
	SupremeGenesisWhite("supreme_genesis_white", 6, new int[]{8, 11, 11, 8}, 15,
			SoundEvents.ARMOR_EQUIP_NETHERITE, 7.0F, 0.25F, () -> Ingredient.of(PolarisItems.SPIRIT_OF_DIVINITY.get())),
